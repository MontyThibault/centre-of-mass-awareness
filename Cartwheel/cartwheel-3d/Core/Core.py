...
class Character(Physics.ArticulatedFigure):
    ...
    __swig_setmethods__["COMController"] = _Core.Character_COMController_set
    __swig_getmethods__["COMController"] = _Core.Character_COMController_get
    if _newclass:COMController = _swig_property(_Core.Character_COMController_get, _Core.Character_COMController_set)
    ...
    def drawPerceivedCOM(self, *args): return _Core.Character_drawPerceivedCOM(self, *args)
...
class RigidBodyError(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, RigidBodyError, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, RigidBodyError, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _Core.new_RigidBodyError(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_setmethods__["arb"] = _Core.RigidBodyError_arb_set
    __swig_getmethods__["arb"] = _Core.RigidBodyError_arb_get
    if _newclass:arb = _swig_property(_Core.RigidBodyError_arb_get, _Core.RigidBodyError_arb_set)
    def getMassE(self): return _Core.RigidBodyError_getMassE(self)
    def getCMPositionE(self, *args): return _Core.RigidBodyError_getCMPositionE(self, *args)
    __swig_destroy__ = _Core.delete_RigidBodyError
    __del__ = lambda self : None;
RigidBodyError_swigregister = _Core.RigidBodyError_swigregister
RigidBodyError_swigregister(RigidBodyError)

class CentreOfMass(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CentreOfMass, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CentreOfMass, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _Core.new_CentreOfMass(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Core.delete_CentreOfMass
    __del__ = lambda self : None;
    def getCOM(self): return _Core.CentreOfMass_getCOM(self)
    def getCOMVelocity(self): return _Core.CentreOfMass_getCOMVelocity(self)
    def getCOME(self): return _Core.CentreOfMass_getCOME(self)
    def getCOMVelocityE(self): return _Core.CentreOfMass_getCOMVelocityE(self)
    def step(self): return _Core.CentreOfMass_step(self)
    def stepDraw(self, *args): return _Core.CentreOfMass_stepDraw(self, *args)
CentreOfMass_swigregister = _Core.CentreOfMass_swigregister
CentreOfMass_swigregister(CentreOfMass)
...
def castToCentreOfMass(*args):
  return _Core.castToCentreOfMass(*args)
castToCentreOfMass = _Core.castToCentreOfMass
